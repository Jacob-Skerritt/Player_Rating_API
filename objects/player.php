...
class Player {
    ...
    function read() {
        ...
        // select all query
        $query = "SELECT
                t.team_name as team_name, p.id, p.player_name, p.player_no, p.player_date_of_birth
            FROM
                " . $this->table_name . " p
                LEFT JOIN
                    teams t
...
// create player
    function create() {
        ...
        $query = "INSERT INTO
                " . $this->table_name . "
            SET
                player_name=:player_name, player_no=:player_no, player_date_of_birth=:player_date_of_birth, team_id=:team_id";
        ...
        $this->player_date_of_birth = htmlspecialchars(strip_tags($this->player_date_of_birth));
        ...
        $stmt->bindParam(":player_date_of_birth", $this->player_date_of_birth);
...
function readOne(){
    ...
    $this->player_date_of_birth = $row['player_date_of_birth'];
}
